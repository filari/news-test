...
class __TwigTemplate_0e28cb485f2db6a2a098872a3d2aacd85ec826ebe1d43f06a941f90d4b132c76 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = ["if" => 13];
        $filters = ["escape" => 7, "render" => 16, "t" => 16];
        $functions = ["url" => 16];
    ...
    <div class=\"row align-items-center justify-content-between d-flex\">
      ...
      <nav id=\"nav-menu-container\">
        ...
        if ((($context["logged_in"] ?? null) == false)) {
          ...
          <li><a href=\"";
            // line 16
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, ($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->renderVar($this->env->getExtension('Drupal\Core\Template\TwigExtension')->getUrl("<front>")) . "/user/login"), "html", null, true));
            echo "\">";
          ...
          <li><a href=\"";
            // line 17
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, ($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->renderVar($this->env->getExtension('Drupal\Core\Template\TwigExtension')->getUrl("<front>")) . "/user/register"), "html", null, true));
    ...
    <div class=\"row align-items-center justify-content-between d-flex\">
      ...
      <nav id=\"nav-menu-container\">
        ...
        <ul class=\"nav-menu\">
          ...
          <li><a href=\"{{ url('<front>')|render ~ '/user/login' }}\">{{ 'Login'|t }}</a></li>
          <li><a href=\"{{ url('<front>')|render ~ '/user/register' }}\" class=\"btn btn-primary text-white\"><i class=\"fa fa-user-plus\"></i> <em>{{ 'Signup'|t }}</em></a></li>
        </ul>
        {% endif %}
