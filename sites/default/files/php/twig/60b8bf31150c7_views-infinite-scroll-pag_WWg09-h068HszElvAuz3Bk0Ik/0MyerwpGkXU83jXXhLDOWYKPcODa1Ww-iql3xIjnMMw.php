...
class __TwigTemplate_682a569f8c2f754233685dd6afcebeb8b02c67b7692d396f7ed9b3dee50ac127 extends \Twig\Template
{
...
";
  ...
  <li class=\"pager__item\">
    <a class=\"button\" href=\"";
            ...
            echo "\" title=\"";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(t("Load more items")));
            echo "\" rel=\"next\">";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["options"] ?? null), "button_text", [])), "html", null, true));
            echo "</a>
  </li>
</ul>
";
...
{% endif %}
", "modules/contrib/views_infinite_scroll/templates/views-infinite-scroll-pager.html.twig", "C:\\xampp\\htdocs\\mukesh\\test\\drupal-news\\modules\\contrib\\views_infinite_scroll\\templates\\views-infinite-scroll-pager.html.twig");
    }
}
