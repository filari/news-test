...
class __TwigTemplate_ef5f9c2beb196ee2e3ffcc34df843efd94f6293cc17ed42629bf7bc3cca138b2 extends \Twig\Template
{
...
";
            ...
            // line 136
            echo "  <fieldset";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "form-group"], "method")), "html", null, true));
            echo ">
    ";
            // line 137
            if (twig_in_filter(($context["label_display"] ?? null), [0 => "before", 1 => "invisible"])) {
...
{% endif %}
", "themes/contrib/bootstrap_barrio/templates/form/form-element.html.twig", "C:\\xampp\\htdocs\\mukesh\\test\\drupal-news\\themes\\contrib\\bootstrap_barrio\\templates\\form\\form-element.html.twig");
    }
}
