...
class __TwigTemplate_e5e26410182791f8f8568591cc4d455d0e2963a3499515d9c5089901d3d9078a extends \Twig\Template
{
...
";
        ...
        if (($context["title"] ?? null)) {
            // line 19
            echo "  <h1";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["title_attributes"] ?? null), "addClass", [0 => "title"], "method")), "html", null, true));
            echo ">";
...
{% endif %}
{{ title_suffix }}
", "themes/contrib/bootstrap_barrio/templates/content/page-title.html.twig", "C:\\xampp\\htdocs\\mukesh\\test\\drupal-news\\themes\\contrib\\bootstrap_barrio\\templates\\content\\page-title.html.twig");
    }
}
